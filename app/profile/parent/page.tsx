    ...
    <div className="min-h-screen bg-[#FAFAF9] py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Manage your account and children&apos;s information</p>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden mb-6">
          ...
          <div className="px-6 pb-6">
            ...
            <h2 className="text-lg font-bold text-gray-900">Mpho Dlamini</h2>
            <p className="text-gray-500 text-sm">Parent · Phakalane, Gaborone</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <Input defaultValue="Mpho Dlamini" className="mt-1 rounded-xl border-gray-200 focus-visible:ring-purple-500" />
            </div>
            <div>
              <Label className="text-sm font-medium text-gray-700">Date of Birth</Label>
              <Input type="date" defaultValue="1990-03-22" className="mt-1 rounded-xl border-gray-200 focus-visible:ring-purple-500" />
            </div>
            <div>
              <Label className="text-sm font-medium text-gray-700">Nationality</Label>
              <Input defaultValue="Motswana" className="mt-1 rounded-xl border-gray-200 focus-visible:ring-purple-500" />
            </div>
            <div>
            ...
            <div>
              ...
              <Input type="email" defaultValue="mpho.dlamini@gmail.com" className="mt-1 rounded-xl border-gray-200 focus-visible:ring-purple-500" />
            </div>
          </div>
          <div className="mt-4">
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 mb-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Button
              size="sm"
              onClick={addChild}
              className="rounded-xl text-white text-sm flex items-center gap-1"
              ...
              <div key={child.id}>
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-800 text-sm">Child {idx + 1}</span>
                  </div>
                  {children.length > 1 && (
                    <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <Label className="text-xs font-medium text-gray-600">Child&apos;s Name</Label>
                    <Input
                      value={child.name}
                      onChange={(e) => updateChild(child.id, "name", e.target.value)}
                      placeholder="e.g. Lebo"
                      className="mt-1 rounded-xl border-gray-200 focus-visible:ring-purple-500 text-sm"
                    />
                  </div>
                  <div>
                ...
                <div className="mt-3">
                  ...
                  <Textarea
                    ...
                    className="mt-1 rounded-xl border-gray-200 focus-visible:ring-purple-500 resize-none text-sm"
                    rows={2}
                  />
                </div>
              </div>
